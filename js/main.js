import { VERSION_LABEL, BUILD_NOTE, BUILD_TIME } from './version.js?v=1.5.72';
import { Net } from './net.js?v=1.5.72';
import { Game } from './game.js?v=1.5.72';
import { CATALOG, CATALOG_BY_ID, unitIntro, RARITY_JA } from './catalog.js?v=1.5.72';
import { loadMeta, saveMeta, buyUnit, setDeckSlot, DECK_SIZE } from './meta.js?v=1.5.72';
import { registerEnemyKinds } from './render.js?v=1.5.72';
import { ALL_KIND_IDS } from './catalog.js?v=1.5.72';
import { setKindTier, POWERUPS, WAVE_KIND_TIERS } from './entities.js?v=1.5.72';
...
function spriteUrl(id) {
  return `assets/enemies/${id}/0.png?v=1.5.72`;
}
