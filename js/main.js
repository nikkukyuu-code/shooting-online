import { VERSION_LABEL } from './version.js?v=1.5.56';
import { Net } from './net.js?v=1.5.56';
import { Game } from './game.js?v=1.5.56';
import { CATALOG, CATALOG_BY_ID, unitIntro, RARITY_JA } from './catalog.js?v=1.5.56';
import { loadMeta, saveMeta, buyUnit, setDeckSlot, DECK_SIZE } from './meta.js?v=1.5.56';
import { registerEnemyKinds } from './render.js?v=1.5.56';
import { ALL_KIND_IDS } from './catalog.js?v=1.5.56';
import { setKindTier, POWERUPS, WAVE_KIND_TIERS } from './entities.js?v=1.5.56';
...
function spriteUrl(id) {
  return `assets/enemies/${id}/0.png?v=1.5.56`;
}
