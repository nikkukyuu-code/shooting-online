import { VERSION_LABEL, BUILD_NOTE, BUILD_TIME, formatVersionTime } from './version.js?v=20260926001515';
import { Net } from './net.js?v=20260926001515';
import { Game } from './game.js?v=20260926001515';
import { CATALOG, CATALOG_BY_ID, unitIntro, RARITY_JA } from './catalog.js?v=20260926001515';
import { loadMeta, saveMeta, buyUnit, setDeckSlot, DECK_SIZE } from './meta.js?v=20260926001515';
import { registerEnemyKinds } from './render.js?v=20260926001515';
import { ALL_KIND_IDS } from './catalog.js?v=20260926001515';
import { setKindTier, POWERUPS, WAVE_KIND_TIERS } from './entities.js?v=20260926001515';
...
function spriteUrl(id) {
  return `assets/enemies/${id}/0.png?v=20260926001515`;
}
