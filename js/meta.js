 ...
 */
import { CATALOG, CATALOG_BY_ID, STARTER_DECK, LEGACY_ID_MAP } from './catalog.js?v=20260926011334';
...
export function buildComDeck(playerDeck, rng = Math.random, opts = {}) {
  ...
  try {
    ...
    let hi = Math.min(P * 1.08, POOL_MAX);
    let lo = Math.min(P * 0.82, POOL_MAX * 0.95);
    if (lo > hi) lo = hi * 0.9;
